    ...
    <div class="container mx-auto px-4 max-w-4xl">
      ...
      <template v-else-if="course">
        ...
        <div
          ...
          class="rounded-2xl overflow-hidden mb-8 h-64"
        >
          <img
          ...
          <div v-if="course.progress" class="mt-6">
            <div class="flex justify-between text-sm text-white/50 mb-2">
              ...
              <span
                ...
                уроков ({{ course.progress.percentage }}%)</span
              >
            </div>
            ...
            >
              ...
              >
                ...
                <div class="text-white/60">
                  <svg
                    v-if="expandedThemes.includes(theme.id)"
                    class="w-6 h-6"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
              ...
              <div
                v-if="expandedThemes.includes(theme.id)"
                class="border-t border-white/10 p-4 space-y-3"
              >
                <div
                  ...
                  <div class="flex flex-wrap justify-between items-start gap-3">
                    <div class="flex-1">
                      ...
                      <p
                        ...
                        class="text-white/50 text-sm mt-1 line-clamp-2"
                      >
                        {{ lesson.call_question }}
                      </p>
                    </div>
                    <NuxtLink
                      :to="
                        lesson.is_locked
                          ? '#'
                          : `/bible-school/lessons/${lesson.slug}`
                      "
                      :class="[
                    ...
                    >
                      ...
                      <template v-else> Начать урок </template>
                    </NuxtLink>
                  </div>
                </div>
                <p
                  v-if="theme.lessons.length === 0"
...
const filteredThemes = computed(() => {
  ...
  return course.value.themes.filter(
    (theme) => theme.lessons && theme.lessons.length > 0,
  );
});
