    ...
    <div class="container mx-auto px-4 max-w-4xl">
      ...
      >
        ...
        <div class="bg-white/5 rounded-lg p-4 mb-6">
          ...
          <div
            class="text-white/80 whitespace-pre-wrap"
        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            <select
              v-model="form.status"
              class="bg-gray-800 text-white w-full px-4 py-2 rounded-lg border border-white/20"
            >
              <option value="approved" class="bg-gray-800 text-white">
                ✅ Одобрено
              </option>
              <option value="rejected" class="bg-gray-800 text-white">
                ❌ Отклонено
              </option>
            </select>
          </div>
