  ...
  <div class="min-h-screen bg-gradient-to-br from-blue-900 to-purple-900 py-12">
    <div class="container mx-auto px-4">
      ...
      >
        <div class="relative">
          <div
            class="w-16 h-16 border-4 border-white/20 rounded-full animate-spin border-t-blue-500"
          ></div>
      ...
      <article v-else-if="about" class="max-w-4xl mx-auto">
        <!-- Hero секция -->
        <div
          class="relative rounded-2xl overflow-hidden mb-8 h-96 animate-fade-in"
        >
          <img
            v-if="imageUrl"
            :src="imageUrl"
          ...
          <div
            v-else
            class="w-full h-full bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center text-8xl"
          >
          ...
          <div
            class="absolute inset-0 flex flex-col justify-end p-8 animate-slide-up"
          >
            <div class="mb-2">
              <button
              ...
              >
                <span class="text-sm">{{
                  getCategoryIcon(about.denomination?.title)
                }}</span>
                {{ about.denomination?.title || "Без категории" }}
              </button>
            </div>
            <h1
              class="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-2"
            >
              {{ about.title }}
            </h1>
        ...
        <!-- Краткое описание -->
        <div
          class="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 mb-8 animate-fade-in"
        >
          ...
          <p
            ...
            class="text-white/80 text-lg leading-relaxed whitespace-pre-line"
          ></p>
        </div>

        <!-- Основной контент -->
        <div
          class="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 prose prose-invert max-w-none animate-fade-in"
        >
          <div
            class="text-white/80 leading-relaxed"
            v-sanitize-html="about.content"
          ></div>
        </div>
        ...
        <div class="mt-8 flex justify-between items-center">
          ...
          >
            <svg
              class="w-5 h-5 group-hover:-translate-x-1 transition duration-300"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
