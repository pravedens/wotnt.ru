<template>
  ...
  >
    ...
    <!-- Модальное окно -->
    <div
      class="relative bg-gradient-to-br from-blue-900 to-purple-900 rounded-2xl max-w-2xl w-full max-h-[80vh] overflow-hidden border border-white/20"
    >
      ...
      <div
        ...
        :class="{
          'max-h-[80vh]': !imageUrl,
          'max-h-[calc(80vh-12rem)]': imageUrl,
        }"
      >
