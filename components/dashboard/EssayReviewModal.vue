<template>
  ...
  >
    <div
      class="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto border border-white/20"
    >
      <div
      ...
      <div class="p-6 space-y-6">
        ...
        <div class="bg-white/5 rounded-lg p-4">
          ...
          <div
            ...
            class="text-white/80 whitespace-pre-wrap break-words max-h-64 overflow-y-auto p-2 bg-white/5 rounded"
          ></div>
        </div>
...
const submitReview = async () => {
  ...
  try {
    ...
    notificationStore.error(
      "Ошибка",
      err?.data?.message || "Не удалось сохранить проверку",
    );
  } finally {
