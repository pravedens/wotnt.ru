      ...
      >
        ...
        >
          ...
          <div class="prose prose-invert max-w-none">
            ...
            <!-- Мета-информация -->
            <div class="flex items-center gap-4 text-white/50 text-sm mb-6 pb-4 border-b border-white/10">
            ...
            <div class="text-white/80 text-lg leading-relaxed" v-html="currentArticle.content">
            </div>
          </div>
        </div>
...
useServerSeoMeta({
  ...
  description: 'История, миссия, ценности и пасторы церкви Слово Истины. Узнайте больше о нашей общине верующих и служениях.',
...
useHead({
  meta: [
    { 
      name: 'description', 
      content: 'История, миссия, ценности и пасторы церкви Слово Истины. Узнайте больше о нашей общине верующих и служениях.' 
    },
    { 
      name: 'keywords', 
      content: 'о нас, история церкви, миссия, ценности, пасторы, служения, община верующих, церковь слово истины' 
    }
  ],
  link: [
...
const selectCategory = async (categoryId: string) => {
  ...
  const oldIndex = categories.value.findIndex(c => c.id === activeCategory.value)
