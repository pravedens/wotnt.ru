      ...
      <div class="flex justify-between items-center">
        ...
        <div class="hidden md:flex items-center gap-6">
          ...
          <template v-else>
            ...
            <NuxtLink 
              to="/auth/register" 
              class="px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg hover:from-blue-600 hover:to-purple-600 transition"
            >
              Регистрация
            </NuxtLink>
          </template>
        ...
        <!-- Мобильные контролы (остаются без изменений) -->
        <div class="flex md:hidden items-center gap-2">
          <!-- Иконка пользователя для мобильных -->
          <NuxtLink 
            v-if="user"
            to="/dashboard"
